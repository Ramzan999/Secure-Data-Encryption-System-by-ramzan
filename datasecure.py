...
if choice == "Home":
  st.subheader(" 🔐 Secure Data Encryption – Lock It. Encrypt It. Secure It.")
  st.markdown("Secure Data Encryption is a powerful solution designed to safeguard sensitive information with advanced encryption techniques. Fast, reliable, and built for maximum protection – your data stays yours, always.")
    ...
    if st.button("Login"):
      if username in stored_data and stored_data[username]["password"] == hash_password(password):
        ...
        if st.session_state.failed_attempts >= 3:
          st.session_state.lockout.time = time.time() + LOCKOUT_DURATION
...
# data store section 
  ...
  if not st.session_state.authenticated_user:
    ...
    passkey = st.text_input("Encryption dey (passphrase)", type="password")
